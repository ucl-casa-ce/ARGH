				...
				if(marker.id!==isThis)
				{
					...
					if(sound!==undefined){sound.stop();}
	  				sound = new Howl({
							mute: false,
							html5: notiOS,
							src: ['resources/sounds/levelup/'+marker.components['sound-sample'].data.src+'.webm','resources/sounds/levelup/'+marker.components['sound-sample'].data.src+'.m4a','resources/sounds/levelup/'+marker.components['sound-sample'].data.src+'.mp3'],
